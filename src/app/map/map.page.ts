  ...
  private loadMarkers() {
    ...
    geojson.features.forEach((addMarker) => {
      ...
      el.addEventListener('click', () => {
        let content = '<ion-card-header><ion-card-title>' + addMarker.properties.title + '</ion-card-title><img src=\"' + addMarker.properties.broadcaster + '\" alt=\"' + addMarker.properties.broadcaster + '\" width=\"10px\" height=\"10px\"></ion-card-header>' +
